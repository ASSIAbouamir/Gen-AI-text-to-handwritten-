...
from typing import Tuple, Optional, Callable, Any, Union, List  # Ajout de List et Union ici
import warnings
...
def raw_rnn(cell: nn.Module, loop_fn: Callable, max_steps: int, initial_state: Any, 
            parallel_iterations: Optional[int] = None, device: Union[str, torch.device] = 'cpu') -> Tuple[Any, Any, Any]:
    """
    ...
    # Get batch_size from initial_state (flatten to find first tensor)
...
def rnn_teacher_force(inputs: torch.Tensor, cell: nn.Module, sequence_length: Union[int, torch.Tensor], 
                      initial_state: Any, device: Union[str, torch.device] = 'cpu') -> Tuple[Any, Any, Any]:
    """
...
def rnn_free_run(cell: nn.Module, initial_state: Any, sequence_length: Union[int, torch.Tensor], 
                 initial_input: Optional[torch.Tensor] = None, device: Union[str, torch.device] = 'cpu') -> Tuple[Any, Any, Any]:
    """
